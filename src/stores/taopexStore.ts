...
const storeId = 'taopex';

export const taopexStore = defineStore(storeId, () => {
    const stationStore = ref(initializeStation(stationId.Taopex));
    ...
    watch(() => powerSampleArr.value.length, () => {
        ...
        // console.log('sample array:', arr, powerTarget.value);
