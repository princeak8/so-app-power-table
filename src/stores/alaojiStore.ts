...
const storeId = 'alaoji';

export const alaojiStore = defineStore(storeId, () => {
    const stationStore = ref(initializeStation(stationId.Alaoji));
    ...
    function set (data: stationType) {
        ...
        mw.value = getPower(data.sections, false);
        mx.value = getMvar(data.sections, false);
