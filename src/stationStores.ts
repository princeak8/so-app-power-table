...
const stations = [
    ...
    { name: "Okpai", store: okpaiStore, showDetails: false },
    ...
    { name: "PARAS ENERGY", store: parasEnergyStore, showDetails: false },
    ...
    { name: "SHIRORO", store: shiroroStore, showDetails: false },
